...
var DemoManager = /** @class */ (function () {
    function DemoManager() {
        var _this = this;
        this.Respond = function (sentiment) { return __awaiter(_this, void 0, void 0, function () {
            var acc, responses, filtered;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        acc = new DemoAccessor();
                        return [4 /*yield*/, acc.GetResponses()];
                    case 1:
                        responses = _a.sent();
